...
const DEFAULT_PARTS = {
  head: [
    { name: 'のうみそ', type: '基本', level: 1, timing: 'オート', cost: '無し', range: '自身', memo: '最大行動値+2' },
