...
const SKILL_DATABASE = {
  ...
  'ロマネスク': [
    ...
    {
      name: '時計仕掛け',
      memo: '【時計仕掛け】 レベル3の改造パーツを追加で1つ獲得する'
    }
  ]
};
  ...
  body: [
    {
      ...
      cost: '1',
      range: '自身',
      memo: '同ターン内の次カウントで使う。マニューバ1つのカウント-1(最低0)'
    },
    {
      name: 'はらわた',
      type: '基本',
...
const COMMON_EXTRA_PARTS = [
...

  {
    ...
    cost: '0',
    range: '自身',
    memo: '自身がダメージを与えた際のみ使用可。白兵・肉弾ダメージ+1'
  },
...

  {
    ...
    cost: '1',
    range: '自身',
    memo: '自身がダメージを与えた際のみ使用可。白兵・肉弾ダメージ+2'
  },
